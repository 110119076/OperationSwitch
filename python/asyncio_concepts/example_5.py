...
# This took 3 seconds to complete both tasks because they were executed sequentially, 
# blocking the main thread until each task was completed. The event loop is blocked 
# by the synchronous time.sleep() function, which prevents the tasks from being executed 
# concurrently.