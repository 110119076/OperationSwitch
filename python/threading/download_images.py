...
# Finished in 9.297787100000278 seconds

# Synchronous execution of the code results in a total execution time of approximately 9.3 seconds, 
# as each image is downloaded one after the other.